...
namespace E3
{
    class Doti : Bitmon
    {
        ...
        public Doti(int posx, int posy, int tiempoDeVida, int esperanzaVida)
        {
            this.posx = posx;
            this.posy = posy;
        ...
        {
            if (bitmon.Get_Especie() == "taplan" )
            {
                return puntosDeAtaque * 1;
            }
            else
            {
                return Convert.ToInt32(puntosDeAtaque * 1);
            }
        }
